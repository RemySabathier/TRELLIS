...
class SparseSubdivide(nn.Module):
    ...
    [RS]
        - Here, 1 point becomes 1 CUBE (8 vertices) with +-1
        - The feature attached to new points are the same as the original point

    * input and output have same feature D
    * The number of coordinates is *8 (2**3)
    """
