...
def construct_voxel_grid(coords):
    """
    Args:
        coords [N,3] coordinates of the sparse points
    * verts (N*8, 3) vertices of the cubes (+1/+0 for each corner)

    Returns:
        - verts_unique (V_LOT, 3) unique vert coordinates of the voxel grid
        - cubes (N, 8) indices in verts_unique for each cube
    """
